...
const config = {
  entry: {
    bundle: path.resolve(__dirname, 'init.jsx')
  },
  output: {
  ...
  plugins: [
    new htmlWebpackPlugin({template: path.resolve(__dirname, 'index.pug')}),
    new copyWebpackPlugin([{from: path.resolve(__dirname, 'img'), to: 'img'}]),
